...
function billmatetrustboa_config() {
    # ini_set("memory_limit","60M");
    $configarray = array(
//        "FriendlyName" => array("Type" => "System", "Value" => "QuickpayTrustbox"),
        "FriendlyName" => array("Type" => "System", "Value" => "Bill Mate Add Payment"),
...
function billmatetrustboa_link($params) { 
    ...
    $myUrlFP = 'https://my-data.se/client/modules/gateways/callback/billmatetrustboafp.php';
